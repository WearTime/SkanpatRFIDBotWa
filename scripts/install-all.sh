...
echo -e "${GRAY}======================================================================${RESET}"
echo ""
echo -e "${GREEN}[INFO] ${CYAN}Complete Installation Script${RESET}"
echo ""
...
echo -e "${GREEN}[INFO] ${CYAN}Installing dependencies..."
npm install

if [ $? -ne 0 ]; then
    echo -e "${RED}[ERROR] ${RED}ailed to install dependencies"
    echo ""
    read -p "Press Enter to return to menu..."
    bash "$PROJECT_ROOT/start.sh"
    exit 0
...
echo -e "${GREEN}[INFO] ${GREEN}Dependencies installed"
echo ""

echo ""
echo -e "${GREEN}[INFO] ${GREEN}Installation complete!"
echo ""
